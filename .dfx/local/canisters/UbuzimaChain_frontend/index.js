...
import { idlFactory } from './UbuzimaChain_frontend.did.js';
export { idlFactory } from './UbuzimaChain_frontend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.UBUZIMACHAIN_FRONTEND_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./UbuzimaChain_frontend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the UbuzimaChain_frontend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./UbuzimaChain_frontend.did.js")._SERVICE>}
 */
export const UbuzimaChain_frontend = createActor(canisterId);
