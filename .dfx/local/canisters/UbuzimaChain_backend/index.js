...
import { idlFactory } from './UbuzimaChain_backend.did.js';
export { idlFactory } from './UbuzimaChain_backend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.UBUZIMACHAIN_BACKEND_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./UbuzimaChain_backend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the UbuzimaChain_backend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./UbuzimaChain_backend.did.js")._SERVICE>}
 */
export const UbuzimaChain_backend = createActor(canisterId);
